...
exports.getListingsByUsername = exports.getAllListings = void 0;
...
const getAllListings = (options = {}) => {
    ...
    if (username) {
        listings = listings.filter((listing) => listing.username.toLowerCase() === username.toLowerCase());
    }
    // Sort listings
    switch (sort) {
        case "oldest":
 ...
 */
const getListingsByUsername = (username, options = {}) => {
    return (0, exports.getAllListings)({ ...options, username });
};
exports.getListingsByUsername = getListingsByUsername;
